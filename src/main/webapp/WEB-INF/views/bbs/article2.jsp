   ...
   <div id="bbs" style="width:50%"><!-- left empty space -->
	...
	<div id="bbsArticle" style="width:100%"><!-- right empty space -->
		<div id="bbsArticle_header">
			<da class="subject" style="font-size:20px; font-weight:bold; width:8%">&nbsp;${dto2.subject2 }</da>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<!-- Manager Mode ON/OFF -->
		...
		onclick="javascript:location.href='<%=cp%>/updated2.action?num2=${dto2.num2}&pageNum2=${pageNum2}'"/>
		<input type="button" value=" Delete" class="btn2" 
		onclick="javascript:location.href='<%=cp%>/deleted2.action?num2=${dto2.num2}&pageNum2=${pageNum2}'"/>
		</div>
	<!-- Manager Mode Eneded -->
		...
		onclick="javascript:location.href='<%=cp%>/list2.action?${params2}'"/><!-- ??? -->
		</div>	
