   ...
   <div id="bbs" style="width:50%"><!-- left empty space -->
	...
	<div id="bbsArticle" style="width:100%"><!-- right empty space -->
		...
		<div id="bbsArticle_header">
			<da class="name" style="font-size:20px; font-weight:bold; width:70%">&nbsp;[${dto4.name4 }]</da>&nbsp;
			<da class="subject" style="font-size:20px; font-weight:bold; width:8%">${dto4.subject4 }</da>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<!-- Manager Mode ON/OFF -->
		...
		onclick="javascript:location.href='<%=cp%>/updated4.action?num4=${dto4.num4}&pageNum4=${pageNum4}'"/>
		<input type="button" value=" Delete " class="btn2" 
		onclick="javascript:location.href='<%=cp%>/deleted4.action?num4=${dto4.num4}&pageNum4=${pageNum4}'"/>
		</div>
	<!-- Manager Mode Ended -->
		...
		onclick="javascript:location.href='<%=cp%>/list4.action?${params4}'"/><!-- 4??? -->
		</div>	
