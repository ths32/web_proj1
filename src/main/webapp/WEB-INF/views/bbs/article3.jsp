...
<!--  -->
   ...
   <div id="bbs" style="width:50%"><!-- left empty space -->
	<div id="bbs_title">
	Notice
	</div>
	<div id="bbsArticle" style="width:100%"><!-- right empty space -->
		<div id="bbsArticle_header">
			<da class="name" style="font-size:20px; font-weight:bold; width:70%">&nbsp;[${dto3.name3 }]</da>&nbsp;
			<da class="subject" style="font-size:20px; font-weight:bold; width:8%">${dto3.subject3 }</da>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<da class="created" style="font-size:13px; font-weight:bold; width:7%">Written</da>&nbsp;&nbsp;
			${dto3.created3 }
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<da style="font-size:13px; font-weight:bold; align:right">Views</da>
			&nbsp;&nbsp;${dto3.hitCount3 }
		</div>
		
		<!--  -->
		<div id="bbsArticle_content">
			<table width="1000" border="0"><!-- 600 -->
	...
	<!-- Manager Mode ON/OFF -->
		...
		onclick="javascript:location.href='<%=cp%>/updated3.action?num3=${dto3.num3}&pageNum3=${pageNum3}'"/>
		<input type="button" value=" Delete" class="btn2" 
		onclick="javascript:location.href='<%=cp%>/deleted3.action?num3=${dto3.num3}&pageNum3=${pageNum3}'"/>
		</div>
	<!-- Manager Mode Ended -->
				
		<div id="Footer" align="center"><!-- rightFooter -->
		<input type="button" value=" List " class="btn2" style="font-size:16px; font-weight:bold; color:#ffffff; background-color:#51546C"
		onclick="javascript:location.href='<%=cp%>/list3.action?${params3}'"/><!-- 3??? -->
		</div>	
