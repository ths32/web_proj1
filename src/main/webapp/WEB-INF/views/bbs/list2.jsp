...
<!--  -->
	...
	<div id="bbsList_header">
			<input type="button" value="TH Telecom" class="btn2" onclick="javascript:location.href='<%=cp2%>/list.action';" style="color:#000000; background-color:#ffffff;"/>		
			<input type="button" value="Direct Shop" class="btn2" onclick="javascript:location.href='<%=cp2%>/list2.action';" style="color:#ffffff; background-color:#f91c16;"/>	
			<input type="button" value="Member Service" class="btn2" onclick="javascript:location.href='<%=cp2%>/list3.action';" style="color:#000000; background-color:#ffffff;"/>	
			<input type="button" value="Roaming" class="btn2" onclick="javascript:location.href='<%=cp2%>/list4.action';" style="color:#000000; background-color:#ffffff;"/>	
	 </div>
	...
	<div id="bbsList_header">
		<div id="leftHeader">
			...
			<form action="" name="searchForm2" method="post">
				<select name="searchKey2" class="selectField">
					<option value="subject2">Subject</option>
					<option value="content2">Content</option>				
				</select>
		<input type="text" name="searchValue2" class="textField">
				<label for="img">
   					<input type="submit" name="submit" id="img" value="" onclick="sendIt2();" style="color:#ffffff;">
		...
		<div id="rightHeader">
			...
			onclick="javascript:location.href='<%=cp2%>/created2.action';"/>		
		</div>	
		<!-- Manager Mode Ended -->
	</div>
	...
	<div id="bbsList_list">
		<div id="title" style="width:100%"><!--  -->
			<dl>
				<dt class="num2">No</dt>
				<dt class="subject2" style="width:72%">Subject</dt><!-- 70% -->
				<dt class="created2" style="width:14%">Written</dt><!-- 8% -->
				<dt class="hitCount2" style="width:7%">Views</dt><!-- 7% -->
			</dl>
		</div>
		<div id="lists">
		<c:forEach var="dto2" items="${lists2}">
			<dl>
				<dd class="num2">${dto2.num2 }</dd>
				<dd class="subject2" style="width:78%"><!-- 70% -->
				<a href="${articleUrl2}&num2=${dto2.num2}">
				${dto2.subject2 }</a></dd>
				<dd class="created2">${dto2.created2 }</dd>
				<dd class="hitCount2" style="width:15%">${dto2.hitCount2 }</dd><!-- width:8% -->
			</dl>
		</c:forEach>
		</div>
