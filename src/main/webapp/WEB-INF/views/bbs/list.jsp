...
<!--  -->	
	 ...
	 <div id="bbsList_header">
			<input type="button" value="TH Telecom" class="btn2" onclick="javascript:location.href='<%=cp%>/list.action';" style="color:#ffffff; background-color:#f91c16;"/>		
			<input type="button" value="Direct Shop" class="btn2" onclick="javascript:location.href='<%=cp%>/list2.action';" style="color:#000000; background-color:#ffffff;"/>	
			<input type="button" value="Member Service" class="btn2" onclick="javascript:location.href='<%=cp%>/list3.action';" style="color:#000000; background-color:#ffffff;"/>	
			<input type="button" value="Roaming" class="btn2" onclick="javascript:location.href='<%=cp%>/list4.action';" style="color:#000000; background-color:#ffffff;"/>	
	 </div>
...
<!--  -->
	<div id="bbsList_header">
		...
		<input type="text" name="searchValue" class="textField">
				<label for="img">
   					<input type="submit" name="submit" id="img" value="" onclick="sendIt();" style="color:#ffffff;">
	...
	<div id="bbsList_list">
		<div id="title" style="width:100%"><!--  -->
			<dl>
				...
				<dt class="subject" style="width:70%">Subject</dt>
				<dt class="created" style="width:8%">Written</dt>
				<dt class="hitCount" style="width:7%">Views</dt>
			</dl>
		</div>
		<div id="lists">
		<c:forEach var="dto" items="${lists}">
			<dl>
				...
				<dd class="subject" style="width:70%">
				<a href="${articleUrl}&num=${dto.num}">
				${dto.subject }</a></dd>
				<dd class="created">${dto.created }</dd>
				<dd class="hitCount" style="width:8%">${dto.hitCount }</dd>
			</dl>
		</c:forEach>
		</div>
