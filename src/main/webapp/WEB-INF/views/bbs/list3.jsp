...
<html><!-- lang="en" -->
  ...
  <script type="text/javascript">
	...
	function sendIt3(){
		...
		var f3 = document.searchForm3; //!!
		
		f3.action = "<%=cp3%>/list3.action";
		f3.submit();
...
<!--  -->
	...
	<div id="bbsList_header">
			<input type="button" value="TH Telecom" class="btn2" onclick="javascript:location.href='<%=cp3%>/list.action';" style="color:#000000; background-color:#ffffff;"/>		
			<input type="button" value="Direct Shop" class="btn2" onclick="javascript:location.href='<%=cp3%>/list2.action';" style="color:#000000; background-color:#ffffff;"/>	
			<input type="button" value="Member Service" class="btn2" onclick="javascript:location.href='<%=cp3%>/list3.action';" style="color:#ffffff; background-color:#f91c16;"/>	
			<input type="button" value="Roaming" class="btn2" onclick="javascript:location.href='<%=cp3%>/list4.action';" style="color:#000000; background-color:#ffffff;"/>	
	 </div>
	...
	<div id="bbsList_header">
		<div id="leftHeader">
			...
			<form action="" name="searchForm3" method="post"><!-- !! -->
				<select name="searchKey3" class="selectField">
					<option value="name3">Class</option>
					<option value="subject3">Subject</option>
					<option value="content3">Content</option>				
				</select>
		<input type="text" name="searchValue3" class="textField">
				<label for="img">
   					<input type="submit" name="submit" id="img" value="" onclick="sendIt3();" style="color:#ffffff;">
		...
		<div id="rightHeader">
			...
			onclick="javascript:location.href='<%=cp3%>/created3.action';"/>		
		</div>	
		<!-- Manager Mode Ended -->
	</div>
	...
	<div id="bbsList_list">
		<div id="title" style="width:100%"><!--  -->
			<dl>
				<dt class="num3" style="width:4%">No</dt>
				<dt class="name3" style="width:5%">Class</dt>
				<dt class="subject3" style="width:71%">Subject</dt><!-- 70 -->
				<dt class="created3" style="width:10%">Written</dt><!-- 8 -->
				<dt class="hitCount3" style="width:8%">Views</dt><!-- 7 -->
			</dl>
		</div>
		<div id="lists">
		<c:forEach var="dto3" items="${lists3}">
			<dl>
				<dd class="num3" style="width:4%">${dto3.num3 }</dd>
				<dd class="name3" style="width:5%">${dto3.name3 }</dd>
				<dd class="subject3" style="width:71%"><!-- 70 -->
				<a href="${articleUrl3}&num3=${dto3.num3}">
				${dto3.subject3 }</a></dd>
				<dd class="created3" style="width:10%">${dto3.created3 }</dd>
				<dd class="hitCount3" style="width:8%">${dto3.hitCount3 }</dd><!-- 8 -->
			</dl>
		</c:forEach>
		</div>
